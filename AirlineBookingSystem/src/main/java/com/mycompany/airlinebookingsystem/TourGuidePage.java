...
public class TourGuidePage extends JFrame {
    ...
    private void initComponents() {
        ...
        scrollPane.setBounds(60, 90, 900, 300);
        add(scrollPane);

        bookTourButton = new JButton("Book Tour with Selected Guide");
        bookTourButton.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        bookTourButton.setBounds(60, 420, 280, 40);
        styleMainButton(bookTourButton);
        add(bookTourButton);

        backButton = new JButton("Back to Main Menu");
        backButton.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        backButton.setBounds(360, 420, 220, 40);
