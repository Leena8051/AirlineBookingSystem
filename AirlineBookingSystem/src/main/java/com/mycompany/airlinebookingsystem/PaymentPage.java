...
public class PaymentPage extends JFrame {
    ...
    private void initComponents() {
        ...
        errorLabel.setBounds(xLabel, y, 600, 25);
        card.add(errorLabel);
    ...
    private void processPayment() {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            PreparedStatement pst = conn.prepareStatement(insertPayment);
            ...
            for (int i = 0; i < BookingPage.selectedSeats.size(); i++) {
                ...
                PreparedStatement t = conn.prepareStatement(sql);
            ...
            String cardSQL = "INSERT INTO CreditCard (card_number, card_holder, expiry_date, cvv, payment_id) VALUES (?, ?, ?, ?, ?)";
            ...
            PreparedStatement rec = conn.prepareStatement(receiptSQL);
